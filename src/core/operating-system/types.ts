import type { AssistanceLevel } from "../coaching/types.js";
import type { AmbientContextDecision, AmbientState, AmbientUpdate } from "../observation/types.js";
...
export interface OperatingPlanner {
