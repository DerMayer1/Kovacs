...
import type { OperatingContracts } from "../../infrastructure/contracts/operating-contracts.js";
import type { CalibrationAnswer, CalibrationInput, DailyPlan, DayProposal, EndDayProposal, OperatingProfile, OperatingPlanner, PlannerExecution, SetupInput, SetupProposal, WeekInput, WeekProposal } from "../../core/operating-system/types.js";
import { CodexExecGateway } from "../../infrastructure/codex/codex-exec-gateway.js";
import { redactSecrets } from "../../core/security/sensitive-content.js";
import type { ManualRequest } from "../../core/coaching/types.js";
...
export class CodexOperatingPlanner implements OperatingPlanner {
  private readonly gateway: CodexExecGateway;

  constructor(private readonly config: RuntimeConfig, private readonly contracts: OperatingContracts) {
    this.gateway = new CodexExecGateway(config.observation.coaching);
  }
