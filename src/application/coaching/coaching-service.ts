...
import type { CoachingConfig } from "../../infrastructure/config/coaching-config.js";
import { loadCoachingConfig } from "../../infrastructure/config/coaching-config.js";
import { createContractValidator, type ContractValidator } from "../../infrastructure/contracts/coaching-contracts.js";
import { prepareContext } from "./project-context.js";
...
import { validateAssistance } from "../../core/coaching/assistance.js";
import type {
  AssistanceLevel,
  ManualRequest,
  Mode,
...
export class KovacsService {
  ...
  static async create(config = loadCoachingConfig(), gateway?: ReasoningGateway): Promise<KovacsService> {
