...
import type { ObservationContracts } from "../contracts/observation-contracts.js";
import type { AmbientEvent, AmbientSettings, AmbientState } from "../../core/observation/types.js";

export class ObservationStateStore {
  private readonly statePath: string;
  private readonly settingsPath: string;

  constructor(private readonly dataDirectory: string, private readonly contracts: ObservationContracts) {
