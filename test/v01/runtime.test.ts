...
import { runCli } from "../../src/v01/cli.js";
import type { GatewayExecution, GatewayInvocation, ProfileResponse, ReasoningGateway } from "../../src/v01/types.js";
...
async function fixture(gateway = new FakeGateway(), budget = 40_000) {
  ...
  const config = { ...loadV01Config(path.resolve(".")), dataDirectory: path.join(temporary, "data"), contextCharacterBudget: budget };
