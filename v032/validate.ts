...
const files = ["src/v03/types.ts", "src/v03/store.ts", "src/v03/controller.ts", "src/v03/planner.ts", "src/v03/electron/main.ts", "src/v02/controller.ts", "src/v032/context-engine.ts", "src/v032/memory.ts", "src/v032/windows-perception.ts", "ui/v0.3/index.html", "ui/v0.3/renderer.js", "ui/v0.3/preload.cjs", "README.md"];
...
record("C06", content["src/v02/controller.ts"].includes("contextualize") && content["src/v032/windows-perception.ts"].includes("windowsHide: true") && all.includes("windows-ocr.ps1"), "native perception runs only inside an authorized intervention");
...
record("C13", quality.every((item) => item.pass), quality.map((item) => item.detail).join("; "));
